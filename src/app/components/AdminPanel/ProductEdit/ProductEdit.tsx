...
const ProductEdit = () => {
    ...
    const handleDelete = async (id: string) => {
        if (confirmDelete && id) {
            ...
            console.log('No product ID provided or confirmDelete not set: ', id, confirmDelete);
        }
    };
    ...
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                <div
                    className={`${styles.editFormContainer} ${editingProduct ? styles.active : ""
                        }`}
                >
                    <h3>Edit Product</h3>
